...
- [2.1 Antes de nada](#2.1%20Antes%20de%20nada)
- [2.2 Configurar Dual Boot](#2.2%20Configurar%20Dual%20Boot)
- [2.3 ¿Cómo hacer el dnf más rápido?](#2.3%20¿Cómo%20hacer%20el%20dnf%20más%20rápido?)
- [2.4 Third-Party Repositories](#2.4%20Third-Party%20Repositories)
	- [2.4.1 RPM Fusion](#2.4.1%20RPM%20Fusion)
	- [2.4.2 flathub](#2.4.2%20flathub)
	- [2.4.3 snap](#2.4.3%20snap)
- [2.5 Instalación completada](#2.5%20Instalación%20completada)
	- [2.5.1 Programas que instalar primero (en orden)](#2.5.1%20Programas%20que%20instalar%20primero%20(en%20orden))
---
## 2.1 Antes de nada
>[!danger] Importante
...
## 2.3 ¿Cómo hacer el dnf más rápido?
...
XCURSOR_SIZE=32
```
### 2.5.1 Programas que instalar primero (en orden)
```shell
